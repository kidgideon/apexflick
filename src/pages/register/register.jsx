...
const Register = () => {
    ...
    const { registerUser, modal, closeModal, googleSignUp } = useRegister(); // Access modal state and closeModal function
        ...
        <div className={styles.overlay}>
            ...
            <div className={styles.formArea}>
                ...
                <div className={styles.continueArea}>
                    <div  onClick={googleSignUp} className={styles.googleContinue}>
